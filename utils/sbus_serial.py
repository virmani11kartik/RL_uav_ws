#!/usr/bin/env python3
"""
SBUS Serial Monitor - Simple real-time RC channel monitor
Usage: python sbus_serial.py COM3
"""

import serial
import sys
import time
from protocols.sbus_decoder import SBUSDecoder
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python sbus_serial.py <PORT>")
        print("Example: python sbus_serial.py COM3")
        sys.exit(1)
