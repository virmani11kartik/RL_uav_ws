...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    progress_gate_reward_scale = 5#2.0          # Reward for getting closer to gate
    gate_pass_reward_scale = 10#5.0              # Large bonus for passing through gate
    velocity_forward_reward_scale = 2#1.0       # Encourage fast forward motion

    # Orientation and navigation (medium weight)
    heading_alignment_reward_scale = 3#0.5      # Reward for pointing toward gate
    ...
    height_reward_scale = 0.6#0.3                 # Penalize deviating from target height
